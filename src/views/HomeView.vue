<template>
  <div id="app">
    <h1 class="nama-pemilik">Mardea-Project</h1>
    <form @submit.prevent="addItem">
      <input v-model="newItemText" placeholder="Tambah Aktivitas">
    ...
    <button @click="clearCompleted" class="hapus">Hapus Jika Selesai</button>
  </div>
</template>
